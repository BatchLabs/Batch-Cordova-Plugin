...
public enum Action
{
    ...
    UPDATE_AUTOMATIC_DATA_COLLECTION("updateAutomaticDataCollection"),
    ...
    PUSH_SET_ANDROID_SHOW_NOTIFICATIONS("push.setAndroidShowNotifications"),
    PUSH_SHOULD_SHOW_ANDROID_NOTIFICATIONS("push.shouldShowAndroidNotifications"),
